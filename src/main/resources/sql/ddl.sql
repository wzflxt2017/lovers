...
(
	...
	user_birthday timestamp(3) comment '用户生日',
	...
	modified_time timestamp(3) comment '最后一次修改时间',
...
create table sys_file(
	...
	upload_time timestamp (3) comment '上传时间',
...
create table user_message(
  ...
  message_time timestamp (3) comment '消息发送时间',
...
create_time timestamp (3) comment '相册创建时间',
modified_time timestamp (3) comment '最后一次修改时间',
...
user_id int(10) comment '上传者id',
create_time timestamp (3) comment '记录时间',
...
comment_time timestamp (3) comment '评论时间',
...
incident_time timestamp (3) comment '事件发生时间',
incident_create_time timestamp (3) comment '记录创建时间',
...
create_time timestamp (3) comment '空间创建时间',
...
start_time timestamp (3) comment '任务开始时间',
end_user_id int(10),
end_user_name varchar(20) comment '用户昵称',
end_time timestamp (3) comment '任务结束时间',
node_id int(10),
link_id: int(10),
status int(2) comment '状态',
